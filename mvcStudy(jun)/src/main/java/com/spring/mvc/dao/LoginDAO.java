...
public class LoginDAO {
	...
	// -------------------------------------------------------		
	public int blockCheck(LoginModel loginModel) {
		String sql = "select count(*) from user_mst where blockdata = ?";
		int block = jdbcTemplate.queryForInt(sql, new Integer(loginModel.getBlockdata()));
		return block;
	}
	// -------------------------------------------------------
