		...
		<main>
			<article class="border_contain">
				<div class="border_header">
					<h1>
						<i class="fas fa-align-left" id="border_icon"></i> 게 시 글
					</h1>
				</div>
				<c:choose>
					...
					<table class="border_table">
						...
						<c:forEach var="bean" items="${borderModel.borderList }">
							...
							<tr>
								...
								<td class="border_title">
									<a href="borderdtl?border_code=${bean.border_code }&page=${page }">${bean.border_title }</a>
								</td>
				...
				<div class="border_footer">
					...
					<div class="select_page">
						<span>
							<a href=borderp?page=${borderModel.pageStart- 1 eq 0 ? 1 : borderModel.pageStart - 1}>
								<i 	class="fas fa-angle-left"></i>
							</a>
						</span>
						<c:forEach var="i" begin="${borderModel.pageStart }" end ="${borderModel.pageEnd }">
							<span>
								<a href=borderp?page=${i}>${i }</a>
							</span>
						</c:forEach>
						<span><a href=borderp?page=${borderModel.pageEnd eq borderModel.totalPage ? borderModel.pageEnd : borderModel.pageEnd + 1}>
						<!-- borderController에서 데이터 받아옴 -->
					...
					<div class="search">
						<form method="get" action="borderSearch">
							...
							</select> <input type="search" name="border_search">
